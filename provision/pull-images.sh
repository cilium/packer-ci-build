...
if [ -z "${NAME_PREFIX}" ]; then
    for img in \
        ...
        docker.io/cilium/istio_pilot:1.1.3 \
        ...
        docker.io/istio/citadel:1.1.3 \
        docker.io/istio/galley:1.1.3 \
        docker.io/istio/kubectl:1.1.3 \
        docker.io/istio/mixer:1.1.3 \
        docker.io/istio/proxy_init:1.1.3 \
        ...
        quay.io/cilium/cilium-builder:2019-07-11 \
        quay.io/cilium/cilium-runtime:2019-07-11 \
